...
std::string WorkerThread::InputFrameToAlgorithm(std::string uuid, int algorithm_id, unsigned char* rgb, int width, int height, long long timestamp, std::vector<int>& alarm_ids)
{
